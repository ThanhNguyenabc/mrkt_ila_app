...
import 'package:mrkt_app/features/profile/profile_cefr_level.dart';
import 'package:mrkt_app/features/profile/profile_header.dart';
import 'package:mrkt_app/features/profile/user_item.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void showBottomUserList(BuildContext context) {
    final allUser = LocalStorage.instance().loggedUserMap;
    final List<Widget> loggedUser = [];

    allUser.forEach((key, value) {
      final isCurrentUser =
          LocalStorage.instance().currentUser?.id == value['id'];
